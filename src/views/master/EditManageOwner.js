...
useEffect(() => {
  const fetchData = async () => {
    try {
      const result = await axios.get(`${API_BASE_URL}/manageowner/edit_manageowner/${id}`);
      const ownerData = result.data.Result[0];
      setValues((prevValues) => ({
        ...
        adl_mobile: ownerData.adl_mobile,
        address: ownerData.address,
        pincode: ownerData.pincode,
        date: new Date(ownerData.date).toLocaleDateString(),
      }));
 ...
 const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length > 0) {
     ...
     axios.put(`${API_BASE_URL}/manageowner/update_manageowner/`+id, {values})
     .then(result => {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mt-3 mb-3">
          <div className="col-6 col-sm-12 col-lg-6 d-flex justify-content-end">
          <TextField id="outlined-basic" label="Email" type='email' variant="outlined" className="w-75"
          value={values.email}  
        ...
        <div className="row  mt-3 mb-3">
          ...
          <div className="col-6 col-sm-12 col-lg-6">
          <TextField id="outlined-basic" label="Pincode" variant="outlined" className="w-75" 
...
export default EditManageOwner;
