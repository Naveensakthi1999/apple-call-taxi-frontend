...
function AddManageCars() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${API_BASE_URL}/managecar/add_managecar`, formData)
    .then(result => {
        if(result.data.Status) {
          ...
          <div className="col-6 col-sm-12 col-lg-6">
            <div className="custom-file w-75">
              ...
              <label className="custom-file-label Carimg-label" 
               style={errors.car_image ? {border: "1px solid red", color: "red"} : {}}
              htmlFor="customFile">
