...
function EditManageDriver() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await axios.get(`${API_BASE_URL}/managedriver/edit_managedriver/${id}`);
        const driverData = result.data.Result[0];
        setValues((prevValues) => ({
          ...
          proof: driverData.proof,
          addhar_no: driverData.addhar_no,
          driving_licence_no: driverData.driving_licence_no,
          email: driverData.email,
          password: driverData.password,
        }));
        setOptionsValue(driverData.owner_username);
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`${API_BASE_URL}/managedriver/update_managedriver/` + id, formData)
      .then(result => {
        if (result.data.Status) {
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mt-3 mb-3">
          ...
          <div className="col-6 col-sm-12 col-lg-6">
            <div className="custom-file w-75 mb-3">
              <input type="file" className="custom-file-input Addharfrontside" name="addharfrontside_image"
                onChange={(e) =>
        ...
        <div className="row mt-3 mb-3">
          ...
          <div className="col-6 col-sm-12 col-lg-6">
            <div className="custom-file w-75 mb-3">
              <input type="file" className="custom-file-input Addharbackside" name="addharbackside_image"
                onChange={(e) =>
        ...
        <div className="row mt-3 mb-3">
          ...
          <div className="col-6 col-sm-12 col-lg-6">
          <div className="custom-file w-75 mb-3">
              <input type="file" className="custom-file-input Drivingbackside" name="drivingbackside_image"
                onChange={(e) =>
...
export default EditManageDriver;
